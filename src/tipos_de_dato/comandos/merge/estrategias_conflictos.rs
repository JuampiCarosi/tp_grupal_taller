...
pub fn resolver_merge_len_2(conflicto: &ConflictoAtomico, linea_base: &str) -> Region {
    match (&conflicto[0].0, &conflicto[1].0) {
        ...
        (DiffType::Unchanged(linea_1), DiffType::Unchanged(_)) => Region::Normal(linea_1.clone()),
